...
namespace Parmacy.Shaar.Migrations
{
    ...
    [Migration("20230815052350_MovePriceToItemInfo")]
    partial class MovePriceToItemInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parmacy.Shaar.Models.BuyInvoice", b =>
                {
                    b.Property<int>("No")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Parmacy.Shaar.Models.SellInvoice", b =>
                {
                    b.Property<int>("No")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Parmacy.Shaar.Models.BuyInvoice", b =>
                {
                    ...
                    b.HasOne("Parmacy.Shaar.Models.User", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("Parmacy.Shaar.Models.ItemPurchase", b =>
                {
                    ...
                    b.HasOne("Parmacy.Shaar.Models.BuyInvoice", "Invoice")
                        .WithMany()
                        .HasForeignKey("Receipt_No")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Parmacy.Shaar.Models.ItemSale", b =>
                {
                    b.HasOne("Parmacy.Shaar.Models.SellInvoice", "Invoice")
                        .WithMany()
